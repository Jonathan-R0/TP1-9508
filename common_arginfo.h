 ...
 * y puerto al mismo.
 * Precondiciones: info != NULL && argc == 4 o 5  && argv !=
 * NULL.
 * Postcondiciones: deja los campos de ip y puertos inicializados. Si no
 ...
 * key al mismo.
 * Precondiciones: info != NULL && validArgs != NULL  && argv !=
 * NULL.
